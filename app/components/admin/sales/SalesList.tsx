...
import { useSalesListStore } from '@/app/store/salesListStore';
import React, { FC, useEffect, useState } from 'react';
import styles from './style/SalesList.module.css';
...
const SalesList: FC<SalesListProps> = ({
  ...
  const [filteredSalesData, setFilteredSalesData] =
    useState<any[]>([]);
  ...
  return (
    <div className={styles.salesListWrap}>
